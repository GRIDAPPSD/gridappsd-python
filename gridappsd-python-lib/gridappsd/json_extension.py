...
def load(
    fo: TextIO, *, cls=None, parse_float=None, parse_int=None, parse_constant=None, object_pairs_hook=None, **kw
) -> Any:
    rv = _json.load(
        fo,
        cls=cls,
...
def loads(
    data: str, *, cls=None, parse_float=None, parse_int=None, parse_constant=None, object_pairs_hook=None, **kw
) -> Any:
    rv = _json.loads(
        data,
        cls=cls,
