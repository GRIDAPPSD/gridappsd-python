...
# from gridappsd.docker_handler import (DEFAULT_DOCKER_DEPENDENCY_CONFIG,
#                                       MYSQL_SCHEMA_INIT_DIR, Containers,
#                                       mysql_setup, run_dependency_containers,
...
#     test_container = client.containers.run(image="alpine",
...
#     assert Path(MYSQL_SCHEMA_INIT_DIR).joinpath(
#         "gridappsd_mysql_dump.sql").is_file()
