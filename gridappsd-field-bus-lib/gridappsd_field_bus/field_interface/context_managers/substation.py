...
def _main():
    ...
    parser.add_argument(
        "--substation_dict",
        help=
        "JSON file containing substation topology dictionary. If this file is not provided then disctionary is requested by Field Bus Manager using upstream message bus.",
        type=str,
        required=False)
